...
import { Gender, Roles, User, BasicUserInfo, MetaUserInfo, UserCredentials, CreditCard } from 'shared/types'
...
class UserModel {
  ...
  async update(values: BasicUserInfo & MetaUserInfo & UserCredentials & CreditCard) {
    try {
      this.rootStore.loading.begin()
